...
export const Header: React.FC<HeaderProps> = ({ mode }) => {
  ...
  const getTitle = () => {
    const mapTitle = {
      add: t('lumifi', 'manageUser.header.addUser'),
      edit: t('lumifi', 'manageUser.header.editUser'),
      list: t('lumifi', 'manageUser.header.listUser'),
    };
    return mapTitle[mode] || t('lumifi', 'manageUser.header.listUser');
  };
  ...
  return (
    <div className='flex justify-between items-center mb-4 border-b-[3px] border-[#D6DBDE] py-4'>
      ...
      <div className='flex justify-between items-center'>
        {mode === 'list' && (
          <button
            onClick={() => navigate('/settings/user/add')}
          ...
          >
            ...
            />
            <span className='hidden sm:block pt-0.5'>{t('lumifi', 'common.addUser')}</span>
